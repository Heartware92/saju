...
const STEM_PERSONALITY: Record<string, { tagline: string; traits: string[] }> = {
  '갑': { tagline: '곧게 뻗어 하늘을 향하는 큰 나무', traits: ['진취적', '강직함', '순수함', '자존심'] },
  '을': { tagline: '바람에 흔들려도 꺾이지 않는 덩굴', traits: ['유연함', '외유내강', '실속', '적응력'] },
  '병': { tagline: '세상을 환히 비추는 태양의 기운', traits: ['열정적', '용기', '공명정대', '활동적'] },
  '정': { tagline: '어둠 속 길을 밝히는 촛불', traits: ['섬세함', '집중력', '외유내강', '장인정신'] },
  '무': { tagline: '만물을 품는 넓은 대지', traits: ['포용력', '신뢰감', '고집', '개척정신'] },
  '기': { tagline: '생명을 키우는 기름진 논밭', traits: ['자애로움', '꼼꼼함', '안정적', '보수적'] },
  '경': { tagline: '거친 바위를 깎아 만든 강철의 기운', traits: ['강건함', '의리', '결단력', '정의감'] },
  '신': { tagline: '빛을 모아 반짝이는 보석', traits: ['예리함', '섬세함', '완벽주의', '외유내강'] },
  '임': { tagline: '끝없이 흘러 바다에 이르는 큰 강', traits: ['포용력', '지혜로움', '유연함', '적응력'] },
  '계': { tagline: '만물을 적시는 고요한 이슬', traits: ['직관력', '섬세함', '스며드는 힘', '변화'] },
};
