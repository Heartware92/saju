    ...
    <div className="min-h-screen bg-space-deep px-4 pt-4 pb-4">
      ...
      <div className="flex items-center relative mb-4 px-1">
        ...
        <div className="flex-1 text-center">
          <h1 className="text-xl font-bold text-text-primary" style={{ fontFamily: 'var(--font-serif)' }}>보관함</h1>
          <p className="text-sm text-text-tertiary mt-0.5">이전에 본 풀이를 그대로 다시 볼 수 있어요</p>
        </div>
      </div>
