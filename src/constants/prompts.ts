...
★ 중요: 각 월의 서술은 반드시 해당 월의 등급·키워드만 참고. 이전 월 내용이 다음 월에 반복·침범 금지.
포맷 — 반드시 "N월(등급·키워드): " 형태로 시작하고 해당 월 고유 기운만 서술:
"5월(길·확장): 편재가 들어오며 투자·사업 확장 흐름이 열린다.
 새로운 파트너나 거래처가 눈에 들어오는 시기.
 과감하게 한 발 내딛되, 계약 조건은 꼼꼼히 볼 것."
