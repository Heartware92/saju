...
10) ★ 섹션 간 중복 금지 — 12섹션 각각 다른 장면·다른 결론.
    같은 명리 근거(용신·격국·신살)는 여러 섹션 등장 OK, 같은 문장·같은 일상 장면 반복 X.
    각 섹션은 자기 영역에 집중: career=직업, wealth=돈, love=연애·배우자, relation=가족·친구·귀인,
    health=장부·건강, luck=대운 흐름, advice=실천 행동. 다른 영역 깊이 다루지 말 것.
