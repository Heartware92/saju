...
10) ★ 섹션 간 중복 금지 — 한 풀이 안에서 같은 명리 근거(용신·격국·신살·합충·12운성·지장간 등)를
    두 섹션 이상에서 같은 문장·같은 각도로 반복 서술하지 말 것.
    같은 근거가 여러 섹션에 자연스럽게 등장할 수 있으나, 각 섹션의 주제(재물·직장·애정·건강 등)에
    맞춰 다른 측면·다른 일상 장면·다른 시간대로 풀어 써야 한다.
    (직원 피드백: 카테고리별 동일 설명 반복 문제 해결)
