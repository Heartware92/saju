...
- "${gyeokguk.name}" 단어: 2차에서 최대 2회 (career 섹션 1회, 다른 1개 섹션 1회).
  격국 시적 별칭은 0회 (1차 general 에서 이미 사용).
- "${pillars.day.gan}${pillars.day.zhi}" 또는 "${pillars.day.gan}수/일간" 인용: 2차에서 최대 2회.
  일주 기질 묘사("차분/분석적/내면 열정/이중성") 0회 — 1차 daymaster 에서 다뤘음.
- "용신인 ${yongSinElement}" + "${yongSin}" 표기: 2차에서 advice 섹션 1회만. 다른 섹션은 결과만 활용 (별칭 없이).
- "결핍 오행" + "새로운 시작 부족/실행력 약함" 인용: 2차에서 advice 1회만. 다른 섹션 0회.
- "보름달", "초승달", "반달" (신강신약 별칭): 0회 — 1차 general 에서 사용.
- "북극성" (용신 별칭): 0회 — 다른 표현으로.

[금지 표현 패턴]
- "이는 X격(별칭)의 특성으로/영향으로/기운으로" — 격국 별칭이 매번 등장 → 금지
- "용신인 X(천간), 즉 식신/상관" — 동일 표기 4번+ → 1회만
- "겉은 차분, 속은 뜨거운/열정" — 이중성 묘사 → 1차에서 다뤘음, 2차 0회
- "예리한 통찰력", "독창적인 사고" — character/career 양쪽 등장 → 1회만
