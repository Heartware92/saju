...
export const SignupPage: React.FC = () => {
  ...
  const { signup, loading, error: authError } = useUserStore();
    ...
    <div style={{
      ...
      <div style={{
        ...
        {!showEmailForm ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '1rem' }}>
              ...
              <button
                type="button"
                onClick={() => alert('구글 회원가입은 준비 중입니다')}
                style={{
                  width: '4rem',
                  height: '4rem',
                  borderRadius: '50%',
              ...
              <button
                type="button"
                onClick={() => alert('네이버 회원가입은 준비 중입니다')}
                style={{
                  width: '4rem',
                  height: '4rem',
                  borderRadius: '50%',
          ...
          {success && (
            <div style={{
              ...
              🎉 회원가입 완료!<br/>
              🪙 1 엽전이 지급되었습니다.<br/>
              <span style={{ fontSize: '0.75rem', fontWeight: '400' }}>로그인 페이지로 이동합니다...</span>
            </div>
          )}
          ...
          <div>
            <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: '#374151', marginBottom: '0.375rem' }}>
              이메일<span style={{ color: '#E63946', marginLeft: '0.25rem' }}>*</span>
            </label>
            <input
              type="email"
          ...
          <div>
            <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: '#374151', marginBottom: '0.375rem' }}>
              비밀번호<span style={{ color: '#E63946', marginLeft: '0.25rem' }}>*</span>
            </label>
            <input
              type="password"
              ...
              required
            />
            <p style={{ marginTop: '0.375rem', fontSize: '0.75rem', color: '#6b7280' }}>영문, 숫자 포함 6자 이상</p>
          </div>

          {/* 비밀번호 확인 */}
          <div>
            <label style={{ display: 'block', fontSize: '0.875rem', fontWeight: '500', color: '#374151', marginBottom: '0.375rem' }}>
              비밀번호 확인<span style={{ color: '#E63946', marginLeft: '0.25rem' }}>*</span>
            </label>
            <input
              type="password"
          ...
          <div style={{ paddingTop: '1rem' }}>
            <label style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}>
              ...
              <span style={{ fontSize: '0.875rem', color: '#374151' }}>
                <span style={{ color: '#E63946', fontWeight: '700' }}>*</span> 이용약관 및 개인정보처리방침에 동의합니다.
                {' '}
                <a
                  href="/terms"
        ...
        <div style={{ marginTop: '2rem', textAlign: 'center', fontSize: '0.875rem' }}>
          <span style={{ color: '#4b5563' }}>이미 계정이 있으신가요?</span>
          {' '}
          <Link
            to="/login"
